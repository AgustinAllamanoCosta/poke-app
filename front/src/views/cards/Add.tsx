          ...
          <CardBody>
            ...
            <Container>
              ...
              <Form.Group className="mb-3" controlId="pokemonName">
                ...
                <Form.Control type="text" placeholder="Pikachu" {...register('name', { required: true })}/>
              </Form.Group>

              <Form.Group className="mb-3" controlId="pokemonHP">
                <Form.Label>HP Points</Form.Label>
                <Form.Control type="number" placeholder="60" {...register('hp', { required: true, valueAsNumber: true })}/>
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="pokemonAttack">
                <Form.Label>BaseAttack</Form.Label>
                <Form.Control type="number" placeholder="0"{...register('attack', {required: true,valueAsNumber: true})}/>
              </Form.Group>
              </Col>
              <Col>
              ...
              <Form.Group className="mb-3" controlId="pokemonWeakMulti">
                <Form.Label>Multipier</Form.Label>
                <Form.Control type="number" placeholder="0" {...register('weaknessMultiplier', { required: false, valueAsNumber: true })}/>
              </Form.Group>

              <Form.Group className="mb-3" controlId="pokemonResistance" >
                <Form.Label>Resistance to</Form.Label>
                <Form.Select {...register('resistanceType', { required: false })} >
                  <option key={`firts-option`} value={undefined}>
                    Select...
                  </option>
                  {Object.values(POKEMON_TYPE).map((value: string) => (
              ...
              <Form.Group className="mb-3" controlId="pokemonResistancePoint">
                <Form.Label>Point</Form.Label>
                <Form.Control type="number" placeholder="0" {...register('resistancePoint', {required: false, valueAsNumber: true})}/>
              </Form.Group>

              <Form.Group className="mb-3" controlId="pokemonExpansion">
                <Form.Label>Expansion</Form.Label>
                <Form.Control type="text" placeholder="Jungle" {...register('expansion', { required: true })}/>
              </Form.Group>
