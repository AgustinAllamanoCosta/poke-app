...
export class CreateCardsDTO {
  ...
  @ApiProperty({ description: 'Type of pokemon for which this card has a weakness', name: 'weaknesType', nullable: true, required: false })
  @IsOptional()
  @IsEnum(POKEMON_TYPE)
  public weaknesType: POKEMON_TYPE;

  @ApiProperty({ description: 'Weakness multiplier', name: 'weaknessMultiplier', nullable: true , required: false })
  @IsOptional()
  @IsInt()
  public weaknessMultiplier: number;

  @ApiProperty({ description: 'Type of pokemon for which this card has a resistance', name: 'resistanceType', nullable: true, required: false })
  @IsOptional()
  @IsEnum(POKEMON_TYPE)
  public resistanceType: POKEMON_TYPE;

  @ApiProperty({ description: 'Resistance point', name: 'resistancePoint', nullable: true, required: false  })
  @IsOptional()
  @IsInt()
  public resistancePoint: number;

  @ApiProperty({ description: 'Expasion', name: 'expansion', nullable: true, required: false  })
  @IsOptional()
  @IsString()
...
export class PokeCardDTO {
  ...
  @ApiProperty({ description: 'Users owning the card', name: 'pokeUser', nullable: true, required: false })
  ...
  @ApiProperty({ description: 'Card weakness', name: 'weakness', nullable: true })
  public weakness: Weakness;

  @ApiProperty({ description: 'Card resistance', name: 'resistance', nullable: true })
